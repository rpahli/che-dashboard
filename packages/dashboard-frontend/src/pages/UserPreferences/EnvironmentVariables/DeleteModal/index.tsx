...
export type Props = {
  isOpen: boolean;
  deleteItems: api.EnvironmentVariable[];
  onCloseModal: () => void;
  onDelete: (tokens: api.EnvironmentVariable[]) => void;
};
export type State = {
  isChecked: boolean;
};

export class EnvironmentVariableDeleteModal extends React.PureComponent<Props, State> {
  ...
  private buildModalContent(): React.ReactElement {
    ...
    return (
      <TextContent>
        ...
        <Checkbox
          id="delete-variables-warning-checkbox"
          isChecked={isChecked}
  ...
  public render(): React.ReactElement {
    ...
    const variables = pluralize(deleteItems.length, 'variable');
    const modalTitle = `Delete Environment Variable ${variables}`;
